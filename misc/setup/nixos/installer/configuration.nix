...

{
  ...
  boot.kernelModules = [ "nomodeset" "kvm-intel" "pktgen" "i915" "admgpu" "nvidia"];
  # For NVIDIA users
  ...
  boot.loader.grub.extraEntries = ''
    menuentry "rEFInd" {
      ...
      insmod chain
      search --fs-uuid --set=root 67C5-EF8A  
  ...
  boot.plymouth = {
  enable = true;  # Set to true if you want Plymouth
  };
  ...
  environment.systemPackages = with pkgs; [
    ...
    gnumeric wget curl neovim emacs nb cached-nix-shell lorri nil neofetch nnn zip xz unzip p7zip ripgrep q yq-go eza fzf mtr iperf3 dnsutils ldns aria2 socat nmap ipcalc cowsay file which xorg.xorgserver xorg.xrandr xorg.xrdb xorg.xinit xorg.xauth mesa glxinfo vulkan-tools libGL libGLU lightdm
